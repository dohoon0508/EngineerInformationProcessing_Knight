          ...
          <ul className="quiz-mode-list">
            ...
            <li>
              ...
              >
                ...
                <span className="quiz-mode-option-desc">(주관식 · 한 바퀴 후 오답만 반복 · 나가면 세션 초기화)</span>
              </Link>
            </li>
          </ul>
        )}
        <p className="quiz-mode-footnote">
          「무한」은 누적 풀이 통계를 반영해 오답·미숙련 문항이 더 자주 나오며, 기록은 그대로 유지됩니다. 「틀린 것만」은 주관식만 한 바퀴 돌린 뒤 틀린 문항만 다시 출제하며, 화면을 나갔다 들어오면 진행이 처음부터입니다.
        </p>
      </div>
    </div>
  );
