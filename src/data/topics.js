...
export const topics = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        nameEn: "MD5",
        aliases: ["MD5", "md5"],
        examDescription: "1991년 R. Rivest가 MD4를 대체하기 위해 고안한 암호화 해시 함수로, 블록 크기 512비트, 키는 128비트",
        shortDescription: "Rivest 설계 해시(MD4 후속)",
      },
      {
        id: "n-nash",
        cryptoClass: "해시",
        ...
        nameKo: "N-NASH",
        nameEn: "N-NASH",
        aliases: ["N-NASH", "n-nash", "nnash", "N-Nash"],
        examDescription: "1989년 일본 NTT에서 발표한 암호화 해시 함수로, 블록과 키가 모두 128비트",
        shortDescription: "NTT N-NASH 해시",
      },
      {
        id: "snefru",
        cryptoClass: "해시",
        ...
        nameKo: "SNEFRU",
        nameEn: "SNEFRU",
        aliases: ["SNEFRU", "snefru"],
        examDescription: "1990년 R. C. Merkle이 발표한 해시 함수로, 32비트 프로세서에서 구현을 용이하게 할 목적으로 개발",
        shortDescription: "Merkle SNEFRU",
      },
      {
        id: "seed",
        cryptoClass: "대칭키",
        category: "양방향",
        subcategory: "블록 암호화 알고리즘",
        nameKo: "SEED",
        nameEn: "SEED",
        aliases: ["SEED", "seed"],
        examDescription: "KISA가 개발한 블록 암호화 알고리즘으로, 블록 크기는 128비트이며 키에 따라 128, 256으로 분류",
        shortDescription: "국내 SEED 블록암호",
      },
      {
        id: "aria",
        cryptoClass: "대칭키",
        ...
        nameEn: "ARIA",
        aliases: ["ARIA", "aria"],
        examDescription: "2004년 국가정보원과 산학연합회가 개발한 블록 암호화 알고리즘",
        shortDescription: "국내 ARIA 블록암호",
      },
      {
        id: "des",
        cryptoClass: "대칭키",
        ...
        nameEn: "DES",
        aliases: ["DES", "des"],
        examDescription: "1975년 미국 NBS에서 발표한 개인키 암호화 알고리즘이다. 블록 크기는 64비트, 키 길이는 56비트이며 16회의 라운드를 수행한다.",
        shortDescription: "64비트 블록 대칭키 DES",
      },
      {
        id: "aes",
        cryptoClass: "대칭키",
        ...
        nameEn: "AES",
        aliases: ["AES", "aes"],
        examDescription: "2001년 NIST에서 발표한 개인키 암호화 알고리즘으로, DES의 한계를 느낀 NIST에서 공모 후 발표",
        shortDescription: "NIST AES(대칭키)",
      },
      {
        id: "rsa",
        cryptoClass: "비대칭키",
        category: "양방향",
        subcategory: "공개키 암호화 알고리즘",
        nameKo: "RSA",
        nameEn: "RSA",
        aliases: ["RSA", "rsa"],
        examDescription:
          "1978년 MIT의 라이베스트, 샤미르, 애들먼에 의해 제안된 공개키 암호화 알고리즘으로, 큰 수를 소인수분해하기 어렵다는 것에 기반하여 제작",
        shortDescription: "소인수분해 난제 기반 공개키",
      },
      {
        id: "ecc",
        cryptoClass: "비대칭키",
        ...
        subcategory: "공개키 암호화 알고리즘",
        nameKo: "ECC",
        nameEn: "Elliptic Curve Cryptography",
        aliases: [
          "ECC",
          "ecc",
          "타원곡선 암호",
        ...
        examDescription:
          "ECC(Elliptic Curve Cryptography, 타원곡선 암호)는 유한체 위의 타원곡선 군 구조를 이용하는 공개키 암호 체계이다. RSA와 비교해 짧은 키 길이로도 동등한 수준의 안전성을 제공할 수 있어, 모바일·임베디드·IoT 등 자원이 제한된 환경에 적합하다.",
        quizPrompt:
          "유한체 위의 타원곡선 군 구조를 이용하는 공개키 암호 체계로, 짧은 키 길이로도 RSA와 유사한 안전성을 낼 수 있어 모바일·임베디드 등에 많이 쓰인다. 이 암호 방식은?",
        shortDescription: "타원곡선 기반 공개키(짧은 키·모바일·IoT에 유리)",
      },
      ...
      },
      {
        ...
        nameKo: "Skipjack",
        nameEn: "Skipjack",
        aliases: ["Skipjack", "skipjack", "스킵잭"],
        examDescription:
          "NSA가 개발한 암호 알고리즘으로 클리퍼 칩(Clipper Chip)에 내장된다. 블록 64비트, 키 80비트이며 음성 통신 장비에 넣어 음성 데이터를 암호화하는 데 쓰인다.",
        shortDescription: "NSA·클리퍼칩·64/80비트",
      },
      {
        id: "tkip",
        category: "암호 / 보안 프로토콜",
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "hdlc",
        group: "데이터 링크 계층 프로토콜",
        nameKo: "HDLC",
        nameEn: "High-level Data Link Control",
        aliases: ["HDLC", "hdlc", "High-level Data Link Control", "high-level data link control"],
        examDescription:
          "데이터 링크 계층에서 사용하는 비트 지향 프로토콜이다. 점대점 또는 다중점 통신에서 사용할 수 있으며, 흐름 제어와 오류 제어 기능을 제공한다. 전송 단위는 프레임이고, 특정 비트 패턴의 혼동을 막기 위해 비트 스터핑 기법을 사용한다. 동기식 데이터 전송 제어에 적합하다.",
        quizPrompt:
          "데이터 링크 계층에서 사용되는 비트 지향 프로토콜로, 점대점 또는 다중점 환경에서 동기식 전송 제어가 가능하며, 프레임 단위 전송과 함께 흐름 제어 및 오류 제어 기능을 제공한다. 또한 데이터 내부의 특정 비트 패턴을 구분하기 위해 비트 스터핑 기법을 사용하는 프로토콜은?",
        shortDescription: "비트 지향·프레임·비트 스터핑·동기식 데이터 링크",
      },
      {
        id: "atm",
        group: "데이터 링크 계층 프로토콜",
        nameKo: "ATM",
        nameEn: "Asynchronous Transfer Mode",
        aliases: ["ATM", "atm", "Asynchronous Transfer Mode", "asynchronous transfer mode", "비동기 전송 모드"],
        examDescription:
          "비동기식 시분할 다중화 방식의 전송 기술이다. 자료를 일정한 크기로 나누어 순서대로 전송하며, 53바이트의 고정 길이 셀을 사용한다. 처리 구조가 단순하고 고속 전송망에 적합하며, 음성·영상·데이터를 통합적으로 처리할 수 있다. B-ISDN과 결합하여 서비스를 제공할 수 있다.",
        quizPrompt:
          "자료를 일정한 크기로 나누어 순서대로 전송하는 방식으로, 53바이트의 고정 길이 셀을 사용하여 처리 과정이 단순하고 고속 전송망에 적합한 기술이 있다. 이 방식은 비동기식 시분할 다중화를 기반으로 하며, 음성·영상·데이터를 통합적으로 전송할 수 있고 B-ISDN과 결합하여 서비스되기도 한다. 이러한 전송 기술은 무엇인가?",
        shortDescription: "53바이트 셀·비동기 시분할 다중화·고속망·B-ISDN",
      },
      {
        id: "ppp",
        group: "데이터 링크 계층 프로토콜",
        nameKo: "PPP",
        nameEn: "Point to Point Protocol",
        aliases: ["PPP", "ppp", "Point to Point Protocol", "point to point protocol", "점대점 프로토콜"],
        examDescription:
          "두 노드를 직접 연결하는 점대점 방식에서 사용하는 데이터 링크 계층 프로토콜이다. 전화선, 전용선, 인터넷 접속과 같은 환경에서 사용되며, 오류 검출 기능을 제공한다. 또한 다양한 네트워크 계층 프로토콜을 지원할 수 있다.",
        quizPrompt:
          "두 시스템이 직접 연결된 환경에서 사용되는 데이터 링크 계층 프로토콜로, 전화선이나 전용선 기반 연결에 활용되며, 점대점 통신을 전제로 한다. 이 방식은 오류 검출 기능을 제공하고 다양한 네트워크 계층 프로토콜을 수용할 수 있어 인터넷 접속 환경에서도 널리 사용된다. 이러한 프로토콜은 무엇인가?",
        shortDescription: "점대점 데이터 링크·오류 검출·다중 네트워크 계층 지원",
      },
      {
        id: "frame-relay",
        group: "데이터 링크 계층 프로토콜",
        nameKo: "프레임 릴레이",
        nameEn: "Frame Relay",
        aliases: ["프레임 릴레이", "프레임릴레이", "frame relay", "Frame Relay"],
        examDescription:
          "데이터 링크 계층에서 사용하는 고속 패킷 교환 기술이다. 오류 제어와 흐름 제어 기능은 단순화하거나 상위 계층에 맡기고, 중계와 다중화 기능 중심으로 고속 전송을 지원한다. 패킷망보다 처리 속도가 빠르며 WAN 환경에서 사용된다.",
        quizPrompt:
          "데이터 링크 계층에서 사용되는 고속 전송 기술 중에는 오류 제어나 흐름 제어를 최소화하거나 상위 계층에 맡기고, 대신 중계와 다중화 기능 중심으로 처리 효율을 높인 방식이 있다. 이 기술은 기존 패킷 교환망보다 빠른 전송이 가능하여 WAN 환경에서 주로 사용된다. 이러한 기술은 무엇인가?",
        shortDescription: "고속 패킷 교환·중계·다중화·WAN",
      },
    ],
  },
  {
