    ...
    items: [
      {
        ...
        aliases: ["구문 커버리지", "구문커버리지", "statement coverage"],
        examDescription: "프로그램 내 모든 명령문을 적어도 한 번 수행하는 커버리지",
        shortDescription: "모든 명령문을 최소 1회 수행",
      },
      {
      ...
      },
      {
        ...
        aliases: ["다중조건 커버리지", "다중 조건 커버리지", "multiple condition coverage"],
        examDescription: "결정 조건 내 모든 개별 조건식을 가능한 모든 조합으로 테스트하여 100% 보장하는 커버리지",
        shortDescription: "조건 조합을 모두 테스트",
      },
      {
        ...
        examDescription: "프로그램의 제어 구조를 그래프 형태로 나타내어 로직을 테스트하는 기법",
      ...
      },
      {
        ...
        examDescription: "프로그램의 반복(루프) 구조에 초점을 맞춰 실시하는 테스트",
